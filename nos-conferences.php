<?php require_once 'template-parts/header.php' ?>
    ...
    <main id="main-conf">
        ...
        <section id="top-conf">
            ...
            <img class="sky"
                 src="https://www.laboiteverte.fr/wp-content/uploads/2014/08/cinemagraph-voyage-alberta-canada-04.gif"
                 width="1519" height="400" alt="">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p>Depuis la première édition, en juin 2020, nous avons eu à coeur de vous proposer
                        ...
                        participants·es a même été franchie cette année).<br><br>Adipisci aut dolore dolorem enim itaque
                        neque optio,
        ...
        <section id="meet-up">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4"><h2>Titre 1</h2><h4>Titre 2</h4>
                    ...
                    <div class="col-lg-4"><img class="img-conf4" src="assets/image/500.gif" height="700" width="494"
                                               alt=""></div>
                </div>

                <div class="row">
                    <div class="col-lg-2"><h2>70</h2><h4>Conférences</h4>
                        <p>À travers 6 univers thématiques : Market, Tech, Entrepreneurship, Society, Work,
                            Design...</p></div>
                    <div class="col-lg-4"><img class="img-conf"
                ...
                <div class="row">
                    <div class="col-lg-3"><img class="img-conf" src="assets/image/500.gif" height="350" width="370"
                                               alt=""></div>
                    <div class="col-lg-3"><h2>Titre 1</h2><h4>Titre 2</h4>
                        <p>Incontestablement, the place to be pour faire parler de vous !</p></div>
